...
import controller.back.courses.InfoScreenCourseController;
...
public class AddTutorialController implements Initializable {
    ...
    void openInfoScreen(String message){
        Parent root;
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../../gui/back/tutorials/InfoScreenTutorial.fxml"));
