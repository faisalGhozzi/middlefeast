...
public class FindTutorialByIdController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Platform.runLater(() -> {
            ...
            Media video = new Media("http://127.0.0.1:8000/uploads/"+tutorial.getVideo());
    ...
    void deleteTutorial(ActionEvent event) {
        Parent root;
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../../gui/back/tutorials/ConfirmDeleteTutorial.fxml"));
