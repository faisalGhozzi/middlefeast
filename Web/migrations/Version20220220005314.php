 ...
 */
final class Version20220220005314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tutorial ADD image VARCHAR(255) DEFAULT NULL');
    }
